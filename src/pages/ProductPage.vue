...
export default {
  ...
  methods: {
    ...
    selectPhotos(e) {
      ...
      else this.activePhotos = [this.photos[2], this.photos[3]];
      // if (this.selectedPhotos == "first"){
